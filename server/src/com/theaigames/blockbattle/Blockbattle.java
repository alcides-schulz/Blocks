...
public class Blockbattle extends AbstractGame {
    ...
    private ArrayList<String> field0 = new ArrayList<String>();
	...
	{
        super.playRound(roundNumber);
        this.field0.add(this.players.get(0).getField().toString(false, false));
	}
    
    public void writeField(int result) throws Exception {
        FileWriter w = new FileWriter("positions.txt", true);
        
        int r = 1;
        for (String f : this.field0) {
            w.write(result + " " + r + " " + f + "\r\n");
            r++;
        }
	...
	public static void main(String args[]) throws Exception
	{
        ...
        //FileWriter w = new FileWriter("positions.txt");
        //w.close();
        ...
        for (int i = 0; i < games; i++) {
            ...
            if (win2 == 0)
                ...
                percent = ((double)win1 / (double)win2 - 1.0) * 100.0;
                
            System.out.println(" " + win1 + "-" + win2 + "-" + draw + " " + percent);
        }
	}
}
